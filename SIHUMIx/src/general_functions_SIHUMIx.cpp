...
std::vector<std::string> bacteria_names = {
    "n_acd1", "n_btv5", "n_bln", "n_bpd2", "n_cbd1", "n_crv0d1", "n_ecs", "n_lpspa1"
};

std::vector<std::string> bacteriaBiomass_names = {
    "biomass_e_acd1", "biomass_e_btv5", "biomass_e_bln", "biomass_e_bpd2", "biomass_e_cbd1", "biomass_e_crv0d1", "biomass_e_ecs", "biomass_e_lpspa1"
};
